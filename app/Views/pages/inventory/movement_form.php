<div class="w-full space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-textSecondary mt-0.5">Catat secara manual stok bahan baku yang masuk, keluar, atau rusak.</p>
        </div>
    </div>
    ...
    <div class="bg-surface rounded-lg border border-border shadow-sm p-6">
        <div x-data="{ type: 'in' }">
            <form action="<?= BASE_URL ?>/inventory/movements/record" method="POST" class="space-y-5 w-full">
