<div class="w-full space-y-6">
    ...
    <div class="flex items-center gap-3">
        <a href="<?= BASE_URL ?>/inventory/opname" class="text-textSecondary hover:text-primary transition-colors bg-surface p-2 rounded-md border border-border shadow-sm">
        ...
        <div>
            ...
            <p class="text-sm text-textSecondary mt-0.5">Lakukan penghitungan fisik bahan baku yang ada di gudang/toko.</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-surface rounded-lg border border-border shadow-sm p-6">
        <div x-data="opnameForm()">
            <form action="<?= BASE_URL ?>/inventory/opname/submit" method="POST" class="space-y-5 w-full">
                ...
                <div class="pt-4 border-t border-border flex justify-end gap-3">
                    <a href="<?= BASE_URL ?>/inventory/opname" class="inline-flex items-center justify-center font-medium rounded-md px-4 py-2 text-sm bg-surface text-textPrimary hover:bg-background border border-border focus:ring-border shadow-sm cursor-pointer transition-colors duration-200">
                        Batal
                    </a>
