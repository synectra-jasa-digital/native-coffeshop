<div class="w-full space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-textSecondary mt-0.5"><?= $ingredient ? 'Ubah informasi bahan baku yang sudah ada.' : 'Tambahkan bahan baku baru ke dalam sistem.' ?></p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-surface rounded-lg border border-border shadow-sm p-6">
        <form action="<?= BASE_URL ?>/inventory/ingredients/save<?= $ingredient ? '/' . $ingredient['id'] : '' ?>" method="POST" class="space-y-5 w-full">
