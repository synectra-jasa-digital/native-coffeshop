<div class="w-full space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-textSecondary mt-0.5">Kategori digunakan untuk mengelompokkan menu di halaman POS.</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-surface rounded-lg border border-border shadow-sm p-6">
        <form action="<?= BASE_URL ?>/categories/save<?= $category ? '/' . $category['id'] : '' ?>" method="POST" class="space-y-5 w-full">
